        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-50 p-8 rounded-2xl shadow-md hover:shadow-lg transition">
            ...
            <p className="text-gray-600 italic text-sm leading-relaxed">
              "Donating blood is my way of giving back. The staff is always professional
              and makes the process comfortable. Knowing I'm helping save lives keeps me
              coming back every 8 weeks."
            </p>
          </div>
          ...
          <div className="bg-gray-50 p-8 rounded-2xl shadow-md hover:shadow-lg transition">
            ...
            <p className="text-gray-600 italic text-sm leading-relaxed">
              "I was nervous about my first donation, but the team made me feel so at ease.
              The process was quick and painless. I'll definitely be donating regularly from now on!"
            </p>
          </div>
          ...
          <div className="bg-gray-50 p-8 rounded-2xl shadow-md hover:shadow-lg transition">
            ...
            <p className="text-gray-600 italic text-sm leading-relaxed">
              "After my surgery, I needed multiple blood transfusions. Thanks to generous donors,
              I recovered fully. Your donation truly makes a difference in people's lives."
            </p>
          </div>
